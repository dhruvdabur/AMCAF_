...
# Save modified content back to custom_road_backup.sdf
with open('custom_road_backup.sdf', 'w') as f:
    f.write(sdf_content)

# Copy the updated backup over to custom_road.sdf
import shutil
shutil.copyfile('custom_road_backup.sdf', 'custom_road.sdf')

print("custom_road_backup.sdf and custom_road.sdf updated successfully!")
