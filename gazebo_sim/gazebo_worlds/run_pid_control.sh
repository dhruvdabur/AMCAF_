#!/bin/bash
# Helper script to run the ROS 2 - Gazebo bridge and the PID Controller Node
...
pkill -f "pid_controller_node.py"
...
echo "Launching PID Controller Node..."
...
# Launch the node
python3 "$SCRIPT_DIR/pid_controller_node.py"
